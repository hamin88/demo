...
//        	currency = Ext.bridgex.ApplicationComponent.getUserCurrency();
            if (currrency != undefined && currrency != null && currrency != '') {
                originalValue = originalValue.toString().replace(currrency, '');
            }
            var value = Ext.util.Format.number(originalValue, Ext.bridgex.ApplicationComponent.getUserCurrencyFormat());
            if (currrency != undefined && currrency != null && currrency != '') {
        ...
        getUserLanguage: function() {
            var result = "E";
            var divUserLang = document.getElementById("userLanguage");
            if (typeof divUserLang != 'undefined' && divUserLang != null) {
                var divValue = divUserLang.innerHTML;
        ...
        getUserDateFormat: function() {
            var result = DEFAULT_DATE_FORMAT;
            var divUserDateFormat = document.getElementById("userDateFormat");
            if (typeof divUserDateFormat != 'undefined' && divUserDateFormat != null) {
                var mapKey = divUserDateFormat.innerHTML;
                var dateFormat = DATE_FORMAT_MAP[mapKey];
        ...
        getUserCurrency: function() {
            var result = DEFAULT_CURRENCY;
            var divUserCurrency = document.getElementById("userCurrency");
            if (typeof divUserCurrency != 'undefined' && divUserCurrency != null) {
                var divValue = divUserCurrency.innerHTML;
                if (divValue != null && divValue != '') {
                    result = divValue;
                }
            }
        ...
        convertDate: function(strDate, srcFormat, targetFormat) {
            if (strDate == null || strDate == "") {
                return "";
            }

            if (targetFormat == undefined || targetFormat == null || targetFormat == "") {
                targetFormat = DEFAULT_DATE_FORMAT;
            }
            if (srcFormat == undefined || srcFormat == null || srcFormat == "") {
                srcFormat = Ext.bridgex.ApplicationComponent.getUserDateFormat();
            }
            if (srcFormat == targetFormat) {
                return strDate;
            }

            var srcDate = Date.parseDate(strDate, srcFormat);
            var resultDate = Ext.util.Format.date(srcDate, targetFormat);
            return resultDate;
        },
        getUserCurrencyFormat: function() {
            var result = '0,000.00';
            var divUserCurrency = document.getElementById("userCurrencyFormat");
            if (typeof divUserCurrency != 'undefined' && divUserCurrency != null) {
                var divValue = divUserCurrency.innerHTML;
                if (divValue != null && divValue != '') {
                    result = divValue;
        ...
        userCurrencyRenderer: function(value, metaData, record, rowIndex, colIndex, store) {
        	//var currency = Ext.bridgex.ApplicationComponent.getUserCurrency();
        	var currency = "$";
            var result = Ext.util.Format.number(value, Ext.bridgex.ApplicationComponent.getUserCurrencyFormat());
        ...
        formatCurrency: function(number) {
            ...
            if (typeof divUserCurrency != 'undefined' && divUserCurrency != null) {
                var divValue = divUserCurrency.innerHTML;
                if (divValue != null && divValue != '') {
                	defaultFormat = divValue;
                }
            }
            var result = Ext.util.Format.number(number, defaultFormat);
            return result;
        }*/
    };
}();